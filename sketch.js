...
function createCash() {
  if (World.frameCount % 200 == 0) {
   // Modify the positions of cash 
    var cash = createSprite(width-Math.round(random(0,width),height-40, 60,60));
...
function createDiamonds() {
  if (World.frameCount % 320 == 0) {
    ...
    var diamonds = createSprite(width-Math.round(random(0,width),height-40, 60,60));
...
function createJwellery() {
  if (World.frameCount % 410 == 0) {
    ...
    var jwellery = createSprite(width-Math.round(random(0,width),height-40, 60,60));
...
function createSword(){
  if (World.frameCount % 530 == 0) {
    ...
    var sword = createSprite(width-Math.round(random(0,width),height-40, 60,60));
